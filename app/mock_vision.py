...
def generate_mock_bounding_boxes(event_id: uuid.UUID) -> list[BoundingBox]:
    ...
    # Force one guaranteed low-confidence box regardless of box_count, so the
    # frontend's red end of the confidence color scale always has something
    # to render.
